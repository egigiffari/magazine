    ...
    <div class="col-md-8">
        ...
        <div class="section-row">
            ...
            <figure class="pull-right">
                <img src="/frontend/img/media-1.jpg" alt="">
            ...
            <figure>
                <img src="/frontend/img/media-2.jpg" alt="">
            </figure>
        ...
        <div class="section-row">
            <div class="post-nav">
                <div class="prev-post">
                    <a class="post-img" href="blog-post.html"><img src="/frontend/img/widget-8.jpg" alt=""></a>
                    <h3 class="post-title"><a href="#">Sed ut perspiciatis, unde omnis iste natus error sit</a></h3>
                    <span>Previous post</span>
                </div>

                <div class="next-post">
                    <a class="post-img" href="blog-post.html"><img src="/frontend/img/widget-10.jpg" alt=""></a>
        ...
        <div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="post post-sm">
                        <a class="post-img" href="blog-post.html"><img src="/frontend/img/post-6.jpg" alt=""></a>
                        <div class="post-body">
                            <div class="post-category">
                ...
                <div class="col-md-4">
                    <div class="post post-sm">
                        <a class="post-img" href="blog-post.html"><img src="/frontend/img/post-7.jpg" alt=""></a>
                        <div class="post-body">
                            <div class="post-category">
                                <a href="category.html">Health</a>
                                <a href="category.html">Lifestyle</a>
        ...
        <div class="section-row">
            ...
            <div class="post-comments">
                ...
                <div class="media">
                    <div class="media-left">
                        <img class="media-object" src="/frontend/img/avatar-2.jpg" alt="">
                    </div>
                    <div class="media-body">
                        ...
                        <div class="media media-author">
                            <div class="media-left">
                                <img class="media-object" src="/frontend/img/avatar-1.jpg" alt="">
                            </div>
                            <div class="media-body">
                                <div class="media-heading">
                                    <h4>John Doe</h4>
                ...
                <div class="media">
                    <div class="media-left">
                        <img class="media-object" src="/frontend/img/avatar-3.jpg" alt="">
                    </div>
                    <div class="media-body">
                        <div class="media-heading">
                            <h4>John Doe</h4>
